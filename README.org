...
Quand le conteneur est lancé avec -v test les liens symboliques
ne marchent pas. Donc il faudrait un submodule pour les fichiers
Make et Emacs.
...
solution socket?
solution en cours run emacs --batch ...
